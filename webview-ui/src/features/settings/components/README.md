...
This directory contains the refactored API Options components for the Dirac extension. The refactoring aims to improve maintainability, code organization, and reduce complexity by separating provider-specific code into modular components.
...
import { BaseUrlField } from "@/shared/ui/BaseUrlField"
import { ModelSelector } from "@/shared/ui/ModelSelector"
import { ModelInfoView } from "@/shared/ui/ModelInfoView"
